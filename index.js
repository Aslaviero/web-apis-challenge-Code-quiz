...
var time = 60;
var score = 0;
// shows questions when start button is clicked
document.querySelector("#start").onclick = () => {

  showQuestions();
 
// Set countdown timer and create h3 tag for display
  setInterval(() => {
...
// Set up H3 to show score of player
  {
...
// function of if loop to show answer buttons and questions
function showQuestions() {
  ...
  if (i < questions.length) {
    ...
    `
    // Hide Start button after game starting game
...
//created submit button for name at end of game
document.querySelector("#names").addEventListener("submit", function (event) {
  ...
  // Local storage to store scores and names 
...
//To show if answer is correct or wrong
